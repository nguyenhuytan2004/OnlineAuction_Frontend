...
const InputFieldEdit = ({ icon, label, value, onChange, disabled }) => {
  const Icon = icon;
  return (
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
      ...
      >
        {/* Header */}
        <div
          className="bg-gradient-to-r from-cyan-600 to-blue-600 p-8
...
const EditUserModal = ({ isOpen, user, onClose, onSubmit }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/70 flex items-center justify-center px-4">
      <div className="bg-gradient-to-br from-slate-950 via-slate-800 to-slate-950 border border-slate-700 rounded-3xl w-full max-w-md shadow-2xl overflow-hidden">
        {/* Header */}
        <div
          className="bg-gradient-to-r from-cyan-600 to-blue-600 p-8
        ...
        <div className="p-6 space-y-6 relative">
          ...
          <div className="space-y-1">
            ...
            <CustomDropdown
              icon={ShieldCheck}
              options={["Admin", "Seller", "Bidder"]}
              selectedIndex={
                form.role === "ADMIN" ? 0 : form.role === "SELLER" ? 1 : 2
              }
              onSelect={(index) => {
                const ROLE_MAP = {
                  0: "ADMIN",
                ...
                setForm({ ...form, role: ROLE_MAP[index] });
              }}
              placeholder="-- Chọn vai trò --"
              accentColor="blue"
            />
          ...
          <div className="flex items-center justify-between bg-slate-800 rounded-lg px-4 py-3">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-3 py-1.5 rounded-full text-sm font-semibold transition-all duration-500 ease-in-out transform active:scale-95 shadow-inner ${
                form.isActive
...
const UserDetailModal = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm">
      <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-3xl w-full max-w-2xl overflow-hidden border border-slate-700 shadow-2xl animate-in zoom-in-95 duration-300 overflow-y-auto">
        <div className="bg-gradient-to-r from-cyan-600 to-blue-600 p-8 text-white sticky top-0">
        ...
        {/* Actions */}
        <div className="flex gap-3 p-8 border-t border-slate-700 justify-end bg-slate-900/50">
          <button
...
const AdminUserManagement = () => {
  ...
  const filteredUsers = users.filter((user) => {
    ...
    const matchesFilter =
      ...
      (filterRole === "Seller" && user.role === "seller") ||
      (filterRole === "Bidder" && user.role === "bidder");
