...
const Ratings = () => {
  ...
  const calculateStats = (ratingsData) => {
    ...
    const percentage =
      totalRatings === 0 ? 0 : Math.round((positiveCount / totalRatings) * 100);
          ...
          <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-2xl shadow-xl p-8 border border-slate-700/50 backdrop-blur-sm hover:shadow-green-500/20 transition-all duration-500">
            <div className="text-center space-y-4">
              ...
              <div className="flex items-center justify-center gap-2 mb-2">
                {Array.from(
                  {
                    length: helpers.getRatingStars(stats.percentage, 100),
                  },
                  (_, i) => (
                    <Star
                      key={i}
                ...
                {Array.from(
                  {
                    length: 5 - helpers.getRatingStars(stats.percentage, 100),
                  },
                  (_, i) => (
                    <Star
                      key={`empty-${i}`}
            ...
            <div className="flex justify-evenly w-full">
              ...
              <div className="flex flex-col items-center gap-2">
                <div className="flex items-center gap-2 min-w-[7rem]">
                  ...
                  <span className="text-slate-300 font-bold">Tích cực</span>
                </div>
              ...
              <div className="flex flex-col items-center gap-2">
                <div className="flex items-center gap-2 min-w-[7rem]">
                  ...
                  <span className="text-slate-300 font-bold">Tiêu cực</span>
                </div>
                    ...
                    <div className="flex items-start justify-between mb-4 pb-4 border-b border-slate-700/50">
                      <div className="flex items-start gap-3 flex-1">
                        <div className="w-14 h-14 flex-shrink-0 relative">
                          ...
                          <img
                            src={rating.product.mainImageUrl || null}
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-2 text-sm text-slate-400">
                            ...
                            <span>
                              {formatters.formatDateTime(rating.ratedAt)}
                            </span>
                          </div>
                        </div>
                      </div>
