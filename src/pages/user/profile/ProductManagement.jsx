...
import { Package, CheckCircle, Star, XCircle } from "lucide-react";
        ...
        const loadData = async () => {
            ...
            try {
                const activeProducts =
                    await userProfileService.getActiveProducts();
                ...
                const updatedSoldProducts = soldProducts.map(
                    (product, index) => ({
                        ...product,
                        isRated: isRatedList[index],
                    }),
                );
                console.log(updatedSoldProducts);
